...
public abstract class AbstractC2880a {
    ...
    /* renamed from: b */
    public static String m4554b(byte[] bArr, int i7, int i8) {
        ...
        int i12 = 0;
        while (i9 < i7 + i8) {
            char charAt = f15057g[i11].charAt(bArr[i9]);
            switch (charAt) {
                case 65520:
                case 65521:
                case 65522:
