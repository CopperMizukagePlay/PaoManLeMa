...
public abstract class AbstractC0451r extends AbstractC0450q {
    /* renamed from: G */
    ...
    public static final boolean m967I(String str, int i7, String str2, int i8, int i9, boolean z7) {
        AbstractC3367j.m5100e(str, "<this>");
        AbstractC3367j.m5100e(str2, "other");
        if (!z7) {
    ...
    public static String m969K(String str, String str2, String str3) {
        AbstractC3367j.m5100e(str, "<this>");
        AbstractC3367j.m5100e(str3, "newValue");
        int m933W = AbstractC0444k.m933W(str, str2, 0, false);
        if (m933W < 0) {
            return str;
        }
        ...
        if (length2 >= 0) {
            ...
            do {
                ...
                m933W = AbstractC0444k.m933W(str, str2, m933W + i7, false);
            } while (m933W > 0);
    ...
    public static boolean m971M(String str, String str2, boolean z7) {
        AbstractC3367j.m5100e(str, "<this>");
        AbstractC3367j.m5100e(str2, "prefix");
        if (!z7) {
    ...
    public static Integer m973O(String str) {
        ...
        int i8;
        AbstractC3367j.m5100e(str, "<this>");
        AbstractC2710c.m4333e(10);
        int length = str.length();
        if (length != 0) {
            int i9 = 0;
            char charAt = str.charAt(0);
            int i10 = -2147483647;
            if (AbstractC3367j.m5101f(charAt, 48) < 0) {
                i7 = 1;
                if (length != 1) {
                    if (charAt != '+') {
                        if (charAt == '-') {
