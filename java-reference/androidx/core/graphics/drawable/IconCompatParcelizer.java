...
public class IconCompatParcelizer {
    ...
    public static IconCompat read(AbstractC0284b abstractC0284b) {
        IconCompat iconCompat = new IconCompat();
        int i7 = iconCompat.f810a;
        if (abstractC0284b.mo623e(1)) {
            i7 = ((C0285c) abstractC0284b).f1037e.readInt();
        }
        iconCompat.f810a = i7;
        ...
        if (abstractC0284b.mo623e(4)) {
            i8 = ((C0285c) abstractC0284b).f1037e.readInt();
        }
        iconCompat.f814e = i8;
        int i9 = iconCompat.f815f;
        if (abstractC0284b.mo623e(5)) {
            i9 = ((C0285c) abstractC0284b).f1037e.readInt();
        }
        iconCompat.f815f = i9;
        ...
        if (abstractC0284b.mo623e(7)) {
            str = ((C0285c) abstractC0284b).f1037e.readString();
        }
        iconCompat.f818i = str;
        String str2 = iconCompat.f819j;
        if (abstractC0284b.mo623e(8)) {
            str2 = ((C0285c) abstractC0284b).f1037e.readString();
        }
    ...
    public static void write(IconCompat iconCompat, AbstractC0284b abstractC0284b) {
        ...
        if (-1 != i7) {
            ...
            ((C0285c) abstractC0284b).f1037e.writeInt(i7);
        }
        byte[] bArr = iconCompat.f812c;
        if (bArr != null) {
        ...
        if (parcelable != null) {
            ...
            ((C0285c) abstractC0284b).f1037e.writeParcelable(parcelable, 0);
        }
        int i8 = iconCompat.f814e;
        if (i8 != 0) {
            abstractC0284b.mo626h(4);
            ((C0285c) abstractC0284b).f1037e.writeInt(i8);
        }
        int i9 = iconCompat.f815f;
        if (i9 != 0) {
            abstractC0284b.mo626h(5);
            ((C0285c) abstractC0284b).f1037e.writeInt(i9);
        }
        ColorStateList colorStateList = iconCompat.f816g;
        if (colorStateList != null) {
            abstractC0284b.mo626h(6);
            ((C0285c) abstractC0284b).f1037e.writeParcelable(colorStateList, 0);
        }
        String str = iconCompat.f818i;
        if (str != null) {
            abstractC0284b.mo626h(7);
            ((C0285c) abstractC0284b).f1037e.writeString(str);
        }
        String str2 = iconCompat.f819j;
        if (str2 != null) {
            abstractC0284b.mo626h(8);
            ((C0285c) abstractC0284b).f1037e.writeString(str2);
        }
    }
}
