...
public final class C2073f {
    ...
    /* renamed from: c */
    public static final ArrayList f12277c = new ArrayList();

    /* renamed from: a */
    public final CharsetEncoder[] f12278a;
    ...
    static {
        ...
        for (int i7 = 0; i7 < 20; i7++) {
            ...
            if (((EnumC2070c) EnumC2070c.f12263h.get(str)) != null) {
                try {
                    f12277c.add(Charset.forName(str).newEncoder());
    ...
    public C2073f(String str, Charset charset) {
        boolean z7;
        int i7;
        boolean z8;
        ...
        if (arrayList.size() == 1 && !z7) {
            this.f12278a = new CharsetEncoder[]{(CharsetEncoder) arrayList.get(0)};
        } else {
            this.f12278a = new CharsetEncoder[arrayList.size() + 2];
            ...
            while (i13 < size3) {
                ...
                i13++;
                this.f12278a[i12] = (CharsetEncoder) obj3;
                i12++;
            }
            this.f12278a[i12] = StandardCharsets.UTF_8.newEncoder();
            this.f12278a[i12 + 1] = StandardCharsets.UTF_16BE.newEncoder();
        }
        if (charset != null) {
            while (true) {
                CharsetEncoder[] charsetEncoderArr = this.f12278a;
                if (i8 < charsetEncoderArr.length) {
                    if (charsetEncoderArr[i8] != null && charset.name().equals(this.f12278a[i8].charset().name())) {
                        i7 = i8;
                        break;
                    }
                    i8++;
