...
public final class InterpolatorC2816a implements Interpolator {
    ...
    public InterpolatorC2816a(float[] fArr) {
        this.f14863a = fArr;
        this.f14864b = 1.0f / (fArr.length - 1);
    }
