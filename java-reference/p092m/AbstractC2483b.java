...
public abstract class AbstractC2483b {
    ...
    /* renamed from: a */
    public static final float[] f13783a;
    ...
    /* renamed from: a */
    public static C2481a m4034a(float f7) {
        float f8 = 0.0f;
        float f9 = 1.0f;
        float m3529p = AbstractC2168e.m3529p(f7, 0.0f, 1.0f);
        float f10 = 100;
        int i7 = (int) (f10 * m3529p);
        if (i7 < 100) {
            float f11 = i7 / f10;
            int i8 = i7 + 1;
            float f12 = i8 / f10;
            ...
            float f15 = ((m3529p - f11) * f14) + f13;
            f8 = f14;
            f9 = f15;
        }
        return new C2481a(f9, f8);
    }
}
