...
public class C0130m implements Serializable, Comparable {

    /* renamed from: h */
    public static final C0130m f528h = new C0130m(new byte[0]);
    ...
    public String mo284a() {
        byte[] bArr = AbstractC0115a.f494a;
        byte[] bArr2 = this.f529e;
        AbstractC3367j.m5100e(bArr2, "<this>");
        AbstractC3367j.m5100e(bArr, "map");
        ...
        return new String(bArr3, AbstractC0434a.f1477a);
    }

    /* renamed from: b */
    public C0130m mo285b(String str) {
    ...
    public String mo287d() {
        ...
        for (byte b8 : bArr) {
            int i8 = i7 + 1;
            char[] cArr2 = AbstractC0315b.f1111a;
    ...
    /* renamed from: g */
    public boolean mo290g(int i7, C0130m c0130m) {
        AbstractC3367j.m5100e(c0130m, "other");
    ...
    public boolean mo291h(int i7, byte[] bArr, int i8, int i9) {
        ...
        if (i7 >= 0) {
            byte[] bArr2 = this.f529e;
            if (i7 <= bArr2.length - i9 && i8 >= 0 && i8 <= bArr.length - i9 && AbstractC0117b.m216a(i7, i8, i9, bArr2, bArr)) {
                return true;
            }
            return false;
        }
    ...
    public final String m293j() {
        ...
        if (str == null) {
            byte[] mo288e = mo288e();
            AbstractC3367j.m5100e(mo288e, "<this>");
            String str2 = new String(mo288e, AbstractC0434a.f1477a);
            this.f531g = str2;
            return str2;
        }
        return str;
    ...
    /* renamed from: k */
    public void mo294k(C0126i c0126i, int i7) {
        ...
        if (i11 == -1) {
            ...
            if (64 <= bArr.length) {
                if (64 == bArr.length) {
                    ...
                    c0130m = new C0130m(AbstractC1804l.m3021N(bArr, 0, 64));
                }
                sb.append(c0130m.mo287d());
                sb.append("…]");
                return sb.toString();
            }
            throw new IllegalArgumentException(AbstractC2487d.m4045i(new StringBuilder("endIndex > length("), bArr.length, ')').toString());
        }
        String m293j = m293j();
        String substring = m293j.substring(0, i11);
        AbstractC3367j.m5099d(substring, "this as java.lang.String…ing(startIndex, endIndex)");
        String m969K = AbstractC0451r.m969K(AbstractC0451r.m969K(AbstractC0451r.m969K(substring, "\\", "\\\\"), "\n", "\\n"), "\r", "\\r");
        if (i11 < m293j.length()) {
