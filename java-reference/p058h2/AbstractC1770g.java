...
public abstract class AbstractC1770g {
    /* renamed from: a */
    public static StaticLayout m2922a(CharSequence charSequence, TextPaint textPaint, int i7, int i8, TextDirectionHeuristic textDirectionHeuristic, Layout.Alignment alignment, int i9, TextUtils.TruncateAt truncateAt, int i10, int i11, boolean z7, int i12, int i13, int i14, int i15) {
        if (i8 < 0) {
            AbstractC2550a.m4078a("invalid start value");
        }
        int length = charSequence.length();
        if (i8 < 0 || i8 > length) {
            AbstractC2550a.m4078a("invalid end value");
        }
        if (i9 < 0) {
            AbstractC2550a.m4078a("invalid maxLines value");
        }
        if (i7 < 0) {
            AbstractC2550a.m4078a("invalid width value");
        }
        if (i10 < 0) {
            AbstractC2550a.m4078a("invalid ellipsizedWidth value");
        }
        ...
        if (i16 >= 33) {
            AbstractC0223b.m499q(obtain, AbstractC0223b.m485c(AbstractC0223b.m505w(AbstractC0223b.m484b(AbstractC0223b.m483a(), i13), i14)));
        }
        if (i16 >= 35) {
    ...
    /* renamed from: b */
    public static final Rect m2923b(TextPaint textPaint, CharSequence charSequence, int i7, int i8) {
        if (charSequence instanceof Spanned) {
            ...
            if (spanned.nextSpanTransition(i7 - 1, i8, MetricAffectingSpan.class) != i8) {
                ...
                while (i7 < i8) {
                    ...
                    C0296c m5103h = AbstractC3367j.m5103h(metricAffectingSpanArr);
                    while (m5103h.hasNext()) {
                        MetricAffectingSpan metricAffectingSpan = (MetricAffectingSpan) m5103h.next();
    ...
    /* renamed from: c */
    public static final float m2924c(int i7, int i8, float[] fArr) {
        return fArr[((i7 - i8) * 2) + 1];
    }

    /* renamed from: d */
    public static final int m2925d(Layout layout, int i7, boolean z7) {
        if (i7 <= 0) {
            return 0;
        }
    ...
    /* renamed from: e */
    public static final int m2926e(C1773j c1773j, Layout layout, C1609r c1609r, int i7, RectF rectF, InterfaceC2063d interfaceC2063d, C0453t c0453t, boolean z7) {
        boolean z8;
        C1768e[] c1768eArr;
        C3877b c3877b;
        float f7;
        ...
        Layout layout2 = c1773j.f10797f;
        int lineStart2 = layout2.getLineStart(i7);
        int m2933f = c1773j.m2933f(i7);
        if (i12 < (m2933f - lineStart2) * 2) {
            AbstractC2550a.m4078a("array.size - arrayStart must be greater or equal than (endOffset - startOffset) * 2");
        }
        ...
        Layout layout3 = (Layout) c1609r.f10325b;
        int lineStart3 = layout3.getLineStart(i7);
        int lineEnd2 = layout3.getLineEnd(i7);
        int m2613g = c1609r.m2613g(lineStart3, false);
        int m2614h = c1609r.m2614h(m2613g);
        int i14 = lineStart3 - m2614h;
        int i15 = lineEnd2 - m2614h;
        Bidi m2610d = c1609r.m2610d(m2613g);
        if (m2610d != null && (createLineBidi = m2610d.createLineBidi(i14, i15)) != null) {
            int runCount = createLineBidi.getRunCount();
            c1768eArr = new C1768e[runCount];
            int i16 = 0;
            while (i16 < runCount) {
                ...
                c1768eArr[i16] = new C1768e(runStart, runLimit, z9);
                i16++;
                runCount = i17;
            }
        } else {
            c1768eArr = new C1768e[]{new C1768e(lineStart3, lineEnd2, layout3.isRtlCharAt(lineStart3))};
        }
        if (z7) {
            c3877b = new C3877b(0, c1768eArr.length - 1, 1);
        } else {
            c3877b = new C3877b(c1768eArr.length - 1, 0, -1);
        }
        int i18 = c3877b.f18163e;
        int i19 = c3877b.f18164f;
        int i20 = c3877b.f18165g;
        if ((i20 <= 0 || i18 > i19) && (i20 >= 0 || i19 > i18)) {
            return -1;
        }
        while (true) {
            C1768e c1768e = c1768eArr[i18];
            boolean z12 = c1768e.f10780c;
            int i21 = c1768e.f10778a;
            int i22 = c1768e.f10779b;
            if (z12) {
            ...
            if (z12) {
                m2924c = m2924c(i21, lineStart, fArr);
            } else {
                m2924c = m2924c(i22 - 1, lineStart, fArr);
            }
            if (z7) {
                    ...
                    if (f7 <= f12) {
                        ...
                        if (mo146j2 != -1 && (mo144h = interfaceC2063d.mo144h(mo146j2)) < i22) {
                            ...
                            while (true) {
                                ...
                                rectF2.left = f9;
                                if (z12) {
                                    m2924c3 = m2924c(i21, lineStart, fArr);
                                } else {
                                    m2924c3 = m2924c(i26 - 1, lineStart, fArr);
                                }
                                rectF2.right = m2924c3;
                    ...
                    if (f7 <= f15) {
                        ...
                        if (mo144h2 != -1 && (mo146j = interfaceC2063d.mo146j(mo144h2)) > i21) {
                            ...
                            while (true) {
                                ...
                                rectF3.left = f8;
                                if (z12) {
                                    m2924c2 = m2924c(i32, lineStart, fArr);
                                } else {
                                    m2924c2 = m2924c(i22 - 1, lineStart, fArr);
                                }
                                rectF3.right = m2924c2;
    ...
    /* renamed from: f */
    public static final boolean m2927f(Spanned spanned, Class cls) {
